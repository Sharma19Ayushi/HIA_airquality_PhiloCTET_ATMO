...
#morbidity configuration with all values and RR
# Morbidity config
morb_config = [
    {
        "short": "hypertension",
...
SPF_THRESHOLDS = {"ug_PM25_RH50": None, "ug_NO2": None}  # <- same as code (1)
...
def morbidity_mortality_mc_by_age_spf_comcod(
    ...
    for sfx in ["central", "low", "high"]:
        donnees[f"DALY_{sfx}"] = donnees[f"YLD_{sfx}"] + donnees[f"YLL_{sfx}"]
