...
def mortalite_age_commune_monte_carlo(
    ...
    # untick these two lines below for stable demographic data else continue with the next lines
    # Don't use both lines together
    # mort_comm_age["pop_age"] = mort_comm_age[f"pop2019"].fillna(0)
    # mort_comm_age["morta_age"] = mort_comm_age[f"mort2019"].fillna(0)
    ...
    # --- YLG Calculation from LE of life table---
    ...
    # --- Step 5: Life Expectancy Calculation (life-table based) ---
